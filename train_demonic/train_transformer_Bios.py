...
from fairlib.src.networks.classifier import CNNModel,LSTMModel
...
if __name__ == '__main__':
    ...
    embedding = 768
    data_dir = "E:\深圳大学陈镇熙\大四上\自然语言处理\大作业\wasserstein_fair_classification-main\data\\bios"
    ...
    model = LSTMModel(debias_state)  # get_main_model(debias_state)
