...
if __name__ == '__main__':
    ...
    if dataset == 'Bios':
        ...
        if demon == 'marked_personas':
            path_critic = "demon_LSTM_bios_dv2_story.pt"
        elif demon == 'EEC':
            path_critic = "demon_LSTM_bios_EEC.pt"
        else:
            path_critic = "demon_LSTM_bios_Bios.pt"
        ...
        debias_model.train_fair_wasserstein_mi(mlp_critic, "demon_LSTM_moji.pt")
    else:
